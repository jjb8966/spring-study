...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        try {
            HasCollectionMember member1 = new HasCollectionMember();
            // 컬렉션 데이터 저장
            member1.setAddress(new AddressPra("homeCity", "street", "zip"));
            member1.getFavoriteFoods().add("치킨");
            member1.getFavoriteFoods().add("피자");
            member1.getFavoriteFoods().add("햄버거");
            member1.getAddressHistory().add(new AddressPra("old1", "street", "zip"));
            member1.getAddressHistory().add(new AddressPra("old2", "street", "zip"));
            ...
            HasCollectionMember findMember = em.find(HasCollectionMember.class, member1.getId());
            ...
            for (AddressPra address : findMember.getAddressHistory()) {
            ...
            // 수정
            System.out.println("=================멤버만 조회================");
            HasCollectionMember findMember2 = em.find(HasCollectionMember.class, member1.getId());
            ...
            findMember2.getAddressHistory().remove(new AddressPra("old1", "street", "zip"));
            findMember2.getAddressHistory().add(new AddressPra("new1", "street", "zip"));
